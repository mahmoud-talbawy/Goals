...
import '/components/create_task_compent/create_task_compent_widget.dart';
import '/components/update_task_compent/update_task_compent_widget.dart';
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    mainAxisAlignment: MainAxisAlignment.start,
                    children: [
                      FutureBuilder<List<TaskRow>>(
                        future: (_model.requestCompleter ??=
                                Completer<List<TaskRow>>()
                                  ..complete(TaskTable().queryRows(
                        ...
                        builder: (context, snapshot) {
                          ...
                          List<TaskRow> listViewTaskRowList = snapshot.data!;
                          ...
                          return ListView.separated(
                            ...
                            itemBuilder: (context, listViewIndex) {
                              final listViewTaskRow =
                                  listViewTaskRowList[listViewIndex];
                              return Padding(
                                      ...
                                      builder: (context) {
                                        return GestureDetector(
                                          ...
                                          child: Padding(
                                            ...
                                            child: Container(
                                              height: 370.0,
                                              child: UpdateTaskCompentWidget(
                                                rowTask: listViewTaskRow,
                                              ),
                                            ),
                                          ),
                                        );
